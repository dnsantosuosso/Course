...
class MultipleChoiceQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        for option in self.options:
            if option != self.options[-1]:
                ...
                options += option
        return 'The options for ' + self.text + ' are ' + options + '.'
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        if answer1.content is answer2.content:
            return 1.0
        else:
            return 0.0
...
class NumericQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return 'The answer for ' + self.text + ' is an integer between ' +\
               str(self.max) + ' and ' + str(self.min) + '.'
    ...
    def validate_answer(self, answer: Answer) -> bool:
        ...
        """
        # TODO: complete the body of this method
        if type(answer.content) == int:
            if self.max >= answer.content >= self.min:
                return True
        return False
...
class YesNoQuestion(Question):
    ...
    def __str__(self) -> str:
        ...
        You can choose the precise format of this string.
        """
        return 'The answer for ' + self.text + ' is either True or False'
...
class CheckboxQuestion(Question):
    ...
    id: the id of this question
    text: the text of this question
    options: the options for answering the question
    ...
    def get_similarity(self, answer1: Answer, answer2: Answer) -> float:
        ...
        unique_str = []
        common_str = []
        for string in answer1.content:
            if string not in unique_str:
                unique_str.append(string)
        for string in answer2.content:
            if string not in unique_str:
                unique_str.append(string)
        for string in answer1.content:
            if (string in answer2.content) and (string not in common_str):
                common_str.append(string)
        for string in answer2.content:
            if (string in answer1.content) and (string not in common_str):
                common_str.append(string)
        return len(common_str) / len(unique_str)
...
class Survey:
    ...
    def __len__(self) -> int:
        ...
        # TODO: complete the body of this method
        return len(self._questions.keys())
    ...
    def __str__(self) -> str:
        ...
        for question in list(self._questions.values()):
            all_questions += question.__str__() + '\n'
    ...
    def _get_criterion(self, question: Question) -> Criterion:
        ...
        """
        # TODO: complete the body of this method
        if question.id in list(self._criteria.keys()):
    ...
    def _get_weight(self, question: Question) -> int:
        ...
        """
        # TODO: complete the body of this method
        if question.id in list(self._weights.keys()):
    ...
    def set_weight(self, weight: int, question: Question) -> bool:
        ...
        """
        # TODO: complete the body of this method
        if question.id not in list(self._questions.keys()):
            return False
        else:
    ...
    def score_students(self, students: List[Student]) -> float:
        ...
        try:
            ...
            for question_id in self._questions:
                if question_id not in self._criteria:
                    criterion = self._default_criterion
                else:
                    criterion = self._criteria[question_id]
                if question_id not in self._weights:
                    weight = self._default_weight
                else:
                    weight = self._weights[question_id]
                answers = []
                for student in students:
                    answers.append(student.get_answer\
                                       (self._questions[question_id]))
                quality_score = criterion.score_answers\
                    (self._questions[question_id], answers)
                total_score += quality_score * weight
            return total_score / len(self._questions)
